...
You should see 1394 tests passing in about 16 seconds. If anything fails, the architecture doc covers common environment issues.
...
tests/            # 1394 tests; mirrors src/ structure
